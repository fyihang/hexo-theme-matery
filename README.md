...
/
hexo-theme-matery`](https://github.com/blinkfox/hexo-theme-matery)，本仓库在[`Apache-2.0 license`](https://github.com/blinkfox/hexo-theme-matery/blob/develop/LICENSE)的许可范围内，根据本人需要进行了部分改动。
...
```bash
git clone https://github.com/fyihang/hexo-theme-matery.git
```
...
```json
[{
    "avatar": "https://example01.com/favicon.ico",
    "name": "示例 01",
    "introduction": "介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍",
    "url": "http://example01.com",
    "title": "前往观摩"
}, {
    "avatar": "https://example02.com/favicon.png",
    "name": "示例 02",
    "introduction": "介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍",
    "url": "https://example02.com",
    "title": "前往观摩"
}, {
    "avatar": "https://example03.com/favicon.jpg",
    "name": "示例 03",
    "introduction": "介绍介绍介绍介绍介绍介绍介绍介绍介绍介绍",
